...
#             if char in invalid_chars:
#                 return True, char
#         return False, None  # Всегда возвращаем кортеж из двух элементов
#
#     def get_code_filename(self):
#         """Получение файла для кода (путь)"""
#
...
#
#         self.text_to_info_out(f'{self.gcode_path}')
#         self.info_out.insertItem(0, f'Код будет сохранен в:')
#
#
#     def input_values_update(self):
#         """Считывание данных введенных вручную"""
...
#
#     def punch_mode_11(self):
#         """Стандартный режим. Данные вручную"""
#         try:
#             # Генерируем G-код
#             g_code_lines = triangle_punch_radial_spiral_needle_full_random_upd(advanced_dict)
#             # Записываем в файл (путь берем из атрибута класса)
#             write_in_file_by_lines(g_code_lines, self.gcode_path)
#
#             self.text_to_info_out(f'{self.gcode_path}')
#             self.info_out.insertItem(0, f'Код успешно сгенерирован и находится в: ')
#             self.info_out.insertItem(0, f'Выполнена генерация стандартного режима пробития на основе данных, '
#                                         f'введенных вручную')
#
#         except Exception as e:
#             self.text_to_info_out(f'ОШИБКА! Не удалось сгенерировать или сохранить код: {str(e)}')
#
#     def gen_code(self):
#         """Генерация кода. Определение кода генерации"""
#
...
#             self.text_to_info_out(f'ОШИБКА! Обработчик {handler_name} не найден')
#         except Exception as e:
#             self.text_to_info_out(f'ОШИБКА! Непредвиденная ошибка при генерации: {str(e)}')
#
# def app_show():
#     """Запуск основного приложения"""
#     # Упрощаем создание приложения
#     app = (QtWidgets.QApplication.instance() or
#            QtWidgets.QApplication(sys.argv))
#     main = MainWindow()
#     main.show()
